...
class Players extends DB{
	...
	public function getPlayerInformation($username){
		...
		if($playerinfo->num_rows == 1){
			...
			$playerinfo->bind_Result($id,$steamid,$first_name,$nickname,$last_name,$age,$player_picture,$total_kills,$total_deaths,$kdratio,$krratio,$played_matches,$team,$standin,$twitch_url,$twitter_url);
